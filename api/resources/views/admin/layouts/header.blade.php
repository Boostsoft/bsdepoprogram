<div class="header">
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item nav-item-box">
            <a href="../../../../../Desktop/themeforest-ONNaIpUk-dreamspos-pos-inventory-management-admin-dashboard-template/html/template/email.html">
        ...
        <li class="nav-item dropdown nav-item-box">
            ...
            <div class="dropdown-menu notifications">
                ...
                <div class="topnav-dropdown-footer">
                    <a href="../../../../../Desktop/themeforest-ONNaIpUk-dreamspos-pos-inventory-management-admin-dashboard-template/html/template/activities.html">View all Notifications</a>
                </div>
            </div>
        </li>
        <!-- /Notifications -->
        ...
        <li class="nav-item nav-item-box">
            <a href="../../../../../Desktop/themeforest-ONNaIpUk-dreamspos-pos-inventory-management-admin-dashboard-template/html/template/general-settings.html"><i data-feather="settings"></i></a>
        </li>
    ...
    <div class="dropdown mobile-user-menu">
        ...
        <div class="dropdown-menu dropdown-menu-right">
            <a class="dropdown-item" href="../../../../../Desktop/themeforest-ONNaIpUk-dreamspos-pos-inventory-management-admin-dashboard-template/html/template/profile.html">My Profile</a>
            <a class="dropdown-item" href="../../../../../Desktop/themeforest-ONNaIpUk-dreamspos-pos-inventory-management-admin-dashboard-template/html/template/general-settings.html">Settings</a>
            <a class="dropdown-item" href="../../../../../Desktop/themeforest-ONNaIpUk-dreamspos-pos-inventory-management-admin-dashboard-template/html/template/signin.html">Logout</a>
        </div>
    </div>
    <!-- /Mobile Menu -->
</div>
